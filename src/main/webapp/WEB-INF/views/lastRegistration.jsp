    ...
    <form:form action="/registeredLast" method="POST" modelAttribute="newUserSecondRegistration" class="form-signin">
        ...
        <div class="form-group">
            <form action="/registeredLast" method="post">
                <input id="b1" type="submit" value="Save" class="btn btn-lg btn-primary btn-block"/>
            </form>
            <form action="/goToRegistration" method="get">
                <input id="b2"type="submit" value="Back" class="btn btn-lg btn-warning btn-block"/>
            </form>
            <form action="/main" method="get">
                <input id="b3" type="submit" value="Cancel" class="btn btn-lg btn-danger btn-block"/>
            </form>
        </div>
